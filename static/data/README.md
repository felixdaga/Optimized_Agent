...
| Path | Contents |
|------|----------|
| `study/manifest.json` | Batch sets (`main` = 9-config grid, `ablation` = 3 cells) |
| `study/compare-main.json` | Compare payload for cross-config charts (from `report.json`) |
| `study/compare-ablation.json` | Ablation compare payload |
